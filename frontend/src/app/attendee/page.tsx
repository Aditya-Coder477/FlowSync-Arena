...
export default function AttendeeDashboard() {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const MOCK_QUEUES: QueueLive = {
        queues: [
          { id: "q1", zone_id: "gate-a", zone_name: "Gate A", name: "Main Entry Queue", length: 47, avg_wait_min: 8.5, predicted_wait_min: 9, is_virtual: false, status: "open", last_updated: new Date().toISOString() },
          { id: "q2", zone_id: "gate-b", zone_name: "Gate B", name: "East Gate Queue", length: 12, avg_wait_min: 2.1, predicted_wait_min: 2.5, is_virtual: false, status: "open", last_updated: new Date().toISOString() },
          { id: "q3", zone_id: "main-hall", zone_name: "Main Hall", name: "Food Stall A Queue", length: 23, avg_wait_min: 5.0, predicted_wait_min: 6, is_virtual: true, status: "open", last_updated: new Date().toISOString() },
          { id: "q4", zone_id: "stage-area", zone_name: "Stage Area", name: "Premium Access", length: 8, avg_wait_min: 1.5, predicted_wait_min: 1.5, is_virtual: true, status: "open", last_updated: new Date().toISOString() },
        ],
        timestamp: new Date().toISOString()
      };
